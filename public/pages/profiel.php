...
<div class="layout-container">
    <nav>
        ...
        <div class="menu">
            ...
            <!--            <a class="actief" href="./profiel.pages"><span class="fas fa-user-circle"></span>Inloggen</a>-->
            <a class="actief" href="profiel.php"><span class="fas fa-user-circle"></span>Owen</a>
